...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-4 fw-bold" style="color: #0051A0; font-size: 1.5rem;">Tambah Surat Intern</h1>
    ...
    <form action="{{ url('/surat_intern') }}" method="POST" class="shadow p-4 bg-white rounded">
        @csrf
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="bagian" class="form-control" id="bagian" value="{{ old('bagian') }}" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="date" name="tanggal_kembali" class="form-control" id="tanggal_kembali" value="{{ old('tanggal_kembali') }}">
            </div>
        </div>
