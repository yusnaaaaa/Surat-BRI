...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-4 fw-bold" style="color: #0051A0; font-size: 1.5rem;">Tambah Surat Rahasia</h1>
    ...
    <!-- Form untuk menambahkan surat rahasia -->
    <form action="{{ url('/surat_rahasia') }}" method="POST" class="shadow p-4 bg-white rounded">
        @csrf
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="dari" class="form-control" id="dari" value="{{ old('dari') }}" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="masuk_ke" class="form-control" id="masuk_ke" value="{{ old('masuk_ke') }}" required>
            </div>
            <div class="col-md-6">
